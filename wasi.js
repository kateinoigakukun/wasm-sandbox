...
var ASM_CONSTS = [function () {
  ...
  WebAssembly.instantiate(wasi_wasm_buffer, imports)
    .then(obj => {
      ...
      try {
        ...
        if (e instanceof WASIExit) { handleWASIExit(e); }
        else {
          console.log(e);
          if (window.wasi_handle_error) window.wasi_handle_error(e);
        }
      }
    })
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=5888;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
